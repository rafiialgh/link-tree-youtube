        ...
        <div className="flex flex-col items-center justify-evenly sm:flex-row sm:mt-14 sm:pb-14 sm:mx-7 sm:gap-x-3">
          <div className="flex justify-center">
            <div className="w-80 mt-14 sm:w-fit sm:mt-0">
              <h1 className="mb-5 text-center font-commissioner text-zinc-500 sm:w-fit sm:mb-0">Made with Next.js and designed happily
                using Figma 😁</h1>
            </div>
          </div>
          <div className="flex items-center justify-center w-fit">
            <div className="flex items-center justify-center mb-14 sm:mb-0">
